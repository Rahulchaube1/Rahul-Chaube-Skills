---
name: mcp-protocol
description: Implementing Model Context Protocol clients and servers.
...
Implementing Model Context Protocol clients and servers. This deep-dive module provides advanced prompt engineering and systemic context rules.
...
```markdown
<instructions>
You are executing the MCP-PROTOCOL skill. 
