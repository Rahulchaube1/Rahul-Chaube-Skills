...
description: Defining explicit JSON tool arguments and schemas.
...
Defining explicit JSON tool arguments and schemas. This deep-dive module provides advanced prompt engineering and systemic context rules.
...
```markdown
<instructions>
You are executing the FUNCTION-CALLING skill. 
