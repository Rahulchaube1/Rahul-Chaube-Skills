...
description: Optimizing KV cache allocations to prevent GPU fragmentation.
...
Optimizing KV cache allocations to prevent GPU fragmentation. This deep-dive module provides advanced prompt engineering and systemic context rules.
...
```markdown
<instructions>
You are executing the PAGED-ATTENTION skill. 
