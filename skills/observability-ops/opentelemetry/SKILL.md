---
name: opentelemetry
description: Emitting spans, traces, and metrics from agent loops.
...
Emitting spans, traces, and metrics from agent loops. This deep-dive module provides advanced prompt engineering and systemic context rules.
...
```markdown
<instructions>
You are executing the OPENTELEMETRY skill. 
