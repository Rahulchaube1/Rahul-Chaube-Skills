...
description: Leveraging thinking tokens with DeepSeek R1.
...
Leveraging thinking tokens with DeepSeek R1. This deep-dive module provides advanced prompt engineering and systemic context rules.
...
```markdown
<instructions>
You are executing the DEEPSEEK-TUNING skill. 
