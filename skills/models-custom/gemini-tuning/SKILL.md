---
name: gemini-tuning
description: Optimizing context and vision pipelines on Gemini.
...
Optimizing context and vision pipelines on Gemini. This deep-dive module provides advanced prompt engineering and systemic context rules.
...
```markdown
<instructions>
You are executing the GEMINI-TUNING skill. 
