---
name: openai-tuning
description: Tuning requests for GPT-4o and Assistants APIs.
...
Tuning requests for GPT-4o and Assistants APIs. This deep-dive module provides advanced prompt engineering and systemic context rules.
...
```markdown
<instructions>
You are executing the OPENAI-TUNING skill. 
