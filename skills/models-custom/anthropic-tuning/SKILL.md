---
name: anthropic-tuning
description: Using XML tags and reasoning patterns with Claude.
...
Using XML tags and reasoning patterns with Claude. This deep-dive module provides advanced prompt engineering and systemic context rules.
...
```markdown
<instructions>
You are executing the ANTHROPIC-TUNING skill. 
