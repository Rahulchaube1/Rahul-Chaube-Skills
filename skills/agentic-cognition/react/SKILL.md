---
name: react
description: Reasoning and acting loops for dynamic tool invocation.
...
Reasoning and acting loops for dynamic tool invocation. This deep-dive module provides advanced prompt engineering and systemic context rules.
...
```markdown
<instructions>
You are executing the REACT skill. 
