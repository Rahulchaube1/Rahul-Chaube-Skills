---
name: graph-rag
description: Linking vector embeddings to Neo4j knowledge graph nodes.
...
Linking vector embeddings to Neo4j knowledge graph nodes. This deep-dive module provides advanced prompt engineering and systemic context rules.
...
```markdown
<instructions>
You are executing the GRAPH-RAG skill. 
