---
name: vision-ocr
description: Extracting structured text coordinate boundaries from screenshots.
...
Extracting structured text coordinate boundaries from screenshots. This deep-dive module provides advanced prompt engineering and systemic context rules.
...
```markdown
<instructions>
You are executing the VISION-OCR skill. 
