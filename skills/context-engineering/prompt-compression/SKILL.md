...
description: Removing redundant tokens while preserving semantic intent.
...
Removing redundant tokens while preserving semantic intent. This deep-dive module provides advanced prompt engineering and systemic context rules.
...
```markdown
<instructions>
You are executing the PROMPT-COMPRESSION skill. 
