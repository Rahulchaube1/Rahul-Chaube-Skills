---
name: prd-spec
description: Drafting clear Product Requirement Documents for AI agents.
...
Drafting clear Product Requirement Documents for AI agents. This deep-dive module provides advanced prompt engineering and systemic context rules.
...
```markdown
<instructions>
You are executing the PRD-SPEC skill. 
