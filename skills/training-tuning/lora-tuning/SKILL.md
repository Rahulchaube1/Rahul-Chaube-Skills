---
name: lora-tuning
description: Training lightweight Low-Rank Adaptation parameters.
...
Training lightweight Low-Rank Adaptation parameters. This deep-dive module provides advanced prompt engineering and systemic context rules.
...
```markdown
<instructions>
You are executing the LORA-TUNING skill. 
